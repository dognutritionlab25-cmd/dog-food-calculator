...
st.set_page_config(page_title="반려견 영양 연구소 계산기 v3.5", layout="wide")
st.title("🐶 반려견 영양 연구소 [AAFCO 생식 계산기 v3.5]")
...
db_data = [
    ...
    {"재료명": "전체 메추리 (뼈 10%)", "category": "bone", "bone_pct": 0.10, "칼로리": 200, "단백질": 20.0, "지방": 12.0, "칼슘": 416,  "인": 250,  "철": 4.0,  "아연": 2.5,  "구리": 0.5,   "망간": 0.02,  "비타민A": 50,    "비타민D": 10, "비타민E": 1.0,  "나트륨": 50},

    # ── 분비성 내장 (organ) ────────────────────────────────────────────────
    # ※ 간·신장·비장·췌장 등 분비 기능을 하는 진짜 내장
